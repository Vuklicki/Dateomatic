...
// For Date and Time values to be presented in the table
// they have to be converted to string format
  ...
  //  if  (!name || !location || !time_zone) {
   ...
   // var cell6 = newRow.insertCell(5);
    ...
    cell2.innerHTML = start_date;
    cell3.innerHTML = start_time;
    cell4.innerHTML = time_zone;
    cell5.innerHTML = end_time;
    cell6.innerHTML = end_date;
